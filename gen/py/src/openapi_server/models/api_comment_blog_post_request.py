...
class ApiCommentBlogPostRequest(BaseModel):
    """
    ...
    comment_text: Optional[StrictStr] = Field(default=None, alias="commentText")
    __properties: ClassVar[List[str]] = ["userCredentials", "blogID", "commentText"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiCommentBlogPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiCommentBlogPostRequest from a dict"""
        if obj is None:
            return None
