...
class ResetPasswordRequest(BaseModel):
    ...
    code: StrictStr = Field(description="6 code in email")
    new_password: SecretStr = Field(description="new password", alias="newPassword")
    __properties: ClassVar[List[str]] = ["email", "code", "newPassword"]
