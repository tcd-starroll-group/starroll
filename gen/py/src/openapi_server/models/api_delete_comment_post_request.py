...
class ApiDeleteCommentPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["userCredentials", "blogID", "commentID"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiDeleteCommentPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiDeleteCommentPostRequest from a dict"""
        if obj is None:
            return None
