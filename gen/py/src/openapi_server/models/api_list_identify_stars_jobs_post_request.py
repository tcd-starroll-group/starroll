...
class ApiListIdentifyStarsJobsPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["limit", "offset", "sort", "order", "userCredentials"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiListIdentifyStarsJobsPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiListIdentifyStarsJobsPostRequest from a dict"""
        if obj is None:
            return None
