...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Get user profile stats
     */
    async apiCheckLoginStatusPost(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CommonMessage> {
        const response = await this.apiCheckLoginStatusPostRaw(initOverrides);
        return await response.value();
    }
     ...
     * get identify stars job result.
     */
    async apiGetIdentifyStarsJobResultPost(requestParameters: ApiGetIdentifyStarsJobResultPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IdentifyStarsJobResult> {
